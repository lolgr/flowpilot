...
source.include_exts = py,png,jpg,kv,atlas,json,capnp,so,dbc,toml,npy,yaml,signed
...
# android.ndk_path = /home/ubuntu/Downloads/cmd/ndk/25.1.8937393

# (str) Android SDK directory (if empty, it will be automatically downloaded.)
# android.sdk_path = /home/ubuntu/Downloads/cmd/
